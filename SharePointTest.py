...
for search in search_list:
    ...
    if search_list.index(search) == 0:
        df.to_csv('C:/Users/JaeMok.Kim/OneDrive - Emerson/General - Korea Marketing & Planning/Market Research/SharePointWrite.csv', index=True, index_label="index", mode='w', encoding='utf-8-sig')
    else:
        df.to_csv('C:/Users/JaeMok.Kim/OneDrive - Emerson/General - Korea Marketing & Planning/Market Research/SharePointWrite.csv', mode='a', index=True, index_label="index", encoding='utf-8-sig', header=False)
